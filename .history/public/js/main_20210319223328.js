...
const propressBarTimeTempValue = document.getElementById(
  "propress-bar-time-temp-value"
);
const propressBarTimeHumiValue = document.getElementById(
  "propress-bar-time-humi-value"
);
const propressBarTimeLuxValue = document.getElementById(
  "propress-bar-time-lux-value"
);
...
socket.on("sendDataSensor", (item) => {
  propressBarTimeTempValue.innerHTML = item.dataTime;
