  ...
  axios
    ...
    .then(function (response) {
      ...
      var html = data.map(function (x) {
        ...
        chart.data[0].dataPoints.push({ label: time, y: x.nhietdo });
        chart.data[1].dataPoints.push({ label: time, y: x.nhietdo1 });
      ...
      document.getElementById("thongbao").innerHTML = `Đã thấy ${data.length} kết quả`
