...
input[0].addEventListener("input", (item) => {
  ...
  axios
    ...
    .then(function (response) {
      ...
      let day = data[0].thoigian.split(" ")[0] + data[0].thoigian.split(" ")[1] + data[0].thoigian.split(" ")[0];
	  let year = 
      console.log(day.splice(3, 1));
      chart.render();
      ...
      var html = data.map(function (x) {
        ...
        chart.options.title.text = `nhiệt độ ngày ${x.thoigian}`;
        return (
          "<tr>" +
          "<td>" +
          x.anhsang +
